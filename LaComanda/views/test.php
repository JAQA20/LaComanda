...
const productos = {
    cafes: [
        {nombre: 'Espresso', precio: 2500, icono: 'fa-coffee'},
        {nombre: 'Americano', precio: 3000, icono: 'fa-coffee'},
        {nombre: 'Latte', precio: 4500, icono: 'fa-coffee'},
        {nombre: 'Cappuccino', precio: 4000, icono: 'fa-coffee'},
        {nombre: 'Flat White', precio: 5000, icono: 'fa-coffee'},
        {nombre: 'Mocha', precio: 5500, icono: 'fa-coffee'}
    ],
    comidas: [
        {nombre: 'Empanada de Carne', precio: 3500, icono: 'fa-bread-slice'},
        {nombre: 'Bruschetta', precio: 6500, icono: 'fa-bread-slice'},
        {nombre: 'Panini Italiano', precio: 8500, icono: 'fa-hamburger'},
        {nombre: 'Ensalada César', precio: 7500, icono: 'fa-leaf'},
        {nombre: 'Croissant Jamón y Queso', precio: 5500, icono: 'fa-bread-slice'},
        {nombre: 'Tostadas Integrales', precio: 4500, icono: 'fa-bread-slice'}
    ],
    especialidades: [
        {nombre: 'Tiramisú Latte', precio: 6500, icono: 'fa-star'},
        {nombre: 'Affogato', precio: 5500, icono: 'fa-ice-cream'},
        {nombre: 'Irish Coffee', precio: 7000, icono: 'fa-glass-whiskey'},
        {nombre: 'Cannoli Siciliano', precio: 4500, icono: 'fa-cookie'},
        {nombre: 'Gelato Artesanal', precio: 5000, icono: 'fa-ice-cream'},
        {nombre: 'Espresso Romano', precio: 6000, icono: 'fa-lemon'}
    ],
    postres: [
        {nombre: 'Tiramisú', precio: 6500, icono: 'fa-cake'},
        {nombre: 'Panna Cotta', precio: 5500, icono: 'fa-birthday-cake'},
        {nombre: 'Cannoli', precio: 4500, icono: 'fa-cookie'},
        {nombre: 'Brownie', precio: 4000, icono: 'fa-cookie-bite'},
        {nombre: 'Cheesecake', precio: 6000, icono: 'fa-cake'},
        {nombre: 'Gelato', precio: 3500, icono: 'fa-ice-cream'}
    ],
    bebidas: [
        {nombre: 'Limonada', precio: 3500, icono: 'fa-lemon'},
        {nombre: 'Té Helado', precio: 3000, icono: 'fa-glass-water'},
        {nombre: 'Smoothie Frutal', precio: 5500, icono: 'fa-blender'},
        {nombre: 'Agua Saborizada', precio: 2500, icono: 'fa-bottle-water'},
        {nombre: 'Jugo Natural', precio: 4000, icono: 'fa-apple-alt'},
        {nombre: 'Frappé', precio: 5000, icono: 'fa-snowflake'}
    ]
};
    ...
    if (tieneOrden) {
        card.innerHTML = `
            <div class="text-center">
                ...
                <button class="btn-entregar w-full py-2 custom-mint text-white rounded-lg hover-mint-bg font-medium">
                Entregar orden
                </button>
            </div>
        `;
...
function agregarProducto(nombre, precio) {
    ...
    if (itemExistente) {
        ...
        ordenActual.push({nombre, precio, cantidad: 1});
    }
