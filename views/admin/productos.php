        ...
        <div class="container-xxl py-4">
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    <button type="button" class="btn btn-outline-brown px-3 py-2" data-bs-toggle="modal" data-bs-target="#modalNuevaCategoria">
                ...
                <form method="POST" action="<?= BASE_URL ?>public/api/nuevaCategoria.php">
                    ...
                    <div class="modal-body pt-3">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label label-comanda">Icono</label>
