...
<head>
    ...
    <style>
        ...
        Indicadores por sub-orden sobre cada mesa. */ .table-notification-stack {
            position: absolute;
            top: -10px;
            right: -10px;
            display: flex;
        ...
        .table-notification-badge svg,
        .table-notification-badge i,
        .table-notification-badge .fa-solid,
        .table-notification-badge .fas {
            color: #fff !important;
            fill: currentColor;
            font-size: .72rem;
        }

        Ambos badges se dejan rojos como pidió Javi. El icono diferencia cocina vs barista,
        y la posición queda por fuera/encima de la mesa. */ .badge-kitchen {
            background: #dc2626 !important;
            background-image: none !important;
        }
