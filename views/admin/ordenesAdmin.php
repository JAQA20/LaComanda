<<<<<<< Updated upstream
    ...
    require_once __DIR__ . "/../../model/Ordenes.php";
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?= BASE_URL ?>public/css/syles.css">
    </head>
        ...
        <div class="pt-20 p-8">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-4 gap-4 mb-8">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow">
                        <div class="text-gray-600 text-sm mb-2">Total Vendido</div>
                        <div class="text-3xl font-bold text-blue-600">Datos en JSON</div>
                    </div>
                </div>
